...
1. Validate install, launch, offline translation, MDict lookup, uninstall, and optional AppData settings deletion behavior with the generated Inno Setup installer.
